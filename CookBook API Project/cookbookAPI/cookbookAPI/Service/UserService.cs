...
namespace CookBook.API.Services
{
    public static class UserService
    {
        ...
        {
            if (oldUserData.UserName != newUserData.UserName && newUserData.UserName != null)
                oldUserData.UserName = newUserData.UserName;

            if (oldUserData.Email != newUserData.Email && newUserData.Email != null)
                oldUserData.Email = newUserData.Email;

            if (oldUserData.Password != newUserData.Password && newUserData.Password != null)
